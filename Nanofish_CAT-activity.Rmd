---
title: "Nanofish: CAT activity"
# AChE activity         CAT activity          GPx activity      GSH content  
# GST activity          Lipid peroxidation    ROS levels        SOD activity
# Motor function: Distance                    Sensory-motor function: Distance  
# Predatory performance         Feeding time        Speed during feeding 
output:
  html_document:
    cache: false
    df_print: paged
...
```{r Multicolinearity, echo=FALSE, message=FALSE, warning=FALSE}
...
tryCatch({
  ...
  distance
  influentialcases_plots(mMR,mname2,mname1,5*10^-log10(max(distance,na.rm=TRUE)))
}, error = function(e) {
